...
let sectionData = [
    ...
    Section(title: "Build a SwiftUI app", text: "20 Sections", logo: "Logo1", image: Image(uiImage: #imageLiteral(resourceName: "Background1")), color: Color("card2")),
...
struct WatchRingsView: View {
    var body: some View {
        HStack(spacing: 30) {
            ...
            HStack(spacing: 12.0) {
                RingView(color1: .blue, color2: .purple, width: 32, height: 32, percent: 54, show: .constant(true))
            }
            .padding(8)
            .background(Color.white)
            .cornerRadius(20)
